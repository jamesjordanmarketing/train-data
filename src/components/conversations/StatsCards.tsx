  ...
  const cards = [
    {
      ...
      icon: FileText,
      description: `${stats.tierDistribution.template} templates, ${stats.tierDistribution.scenario} scenarios`,
      trend: null,
    },
    {
      title: 'Approved',
    ...
    },
    {
      ...
      icon: Clock,
      description: `${stats.needsRevision} need revision`,
      trend: null,
    ...
    },
    {
      ...
      icon: TrendingUp,
      description: `${stats.highQuality} high quality (8+)`,
