...
pmc/system/plans/context-carries/context-carry-info-10-07-25-153pm.md
...
Your task is to update: pmc/system/plans/context-carries/context-carry-info-10-07-25-153pm.md with the details of what I am requesting below:

ok we will upload this version of the app and build it in Vercel. Then we will test it and debug it using another ai agent q/a engineeer window. We have not done any testing yet. So create a full write up of what we accomplished in this chat window and give the q/a engineer the context and instructions it will need to successfully assist me in polishing this module.

In the next carryover file: pmc/system/plans/context-carries/context-carry-info-10-07-25-153pm.md write a spec to get this done. Delete any sections which are not relevant.
...
## 4. Review Process
- Read each section of `pmc/system/plans/context-carries/context-carry-info-10-07-25-153pm.md` carefully
...
1. A summary of the active development context as you understand it from reading the: ## Active Development Focus section of the pmc/system/plans/context-carries/context-carry-info-10-07-25-153pm.md
