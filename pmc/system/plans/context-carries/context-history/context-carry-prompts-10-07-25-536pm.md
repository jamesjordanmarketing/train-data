...
pmc/system/plans/context-carries/context-carry-info-10-07-25-536pm.md
...
You are not going to execute the below. Your task is to update: pmc/system/plans/context-carries/context-carry-info-10-07-25-536pm.md with the details of what I am requesting below:

ok we will have uploaded this version of the app and built it in Vercel. 
It works and we discovered that not all dimensions are being populated. We are now following this action plan:

pmc\context-ai\pmct\c-alpha-build-spec_v3.3_quick-wins-addon_v1.md

and I have just completed running: TASK 2.3: Verify Chunk Type
...
In the next carryover file: pmc/system/plans/context-carries/context-carry-info-10-07-25-536pm.md write a spec to get this done. Delete any sections which are not relevant.
...
## 4. Review Process
- Read each section of `pmc/system/plans/context-carries/context-carry-info-10-07-25-536pm.md` carefully
...
1. A summary of the active development context as you understand it from reading the: ## Active Development Focus section of the pmc/system/plans/context-carries/context-carry-info-10-07-25-536pm.md
