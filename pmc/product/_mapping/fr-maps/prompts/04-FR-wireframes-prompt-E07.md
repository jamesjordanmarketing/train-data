...
Parameters
- FR Number: FR7.1.1
- Stage Name: Stage 7 — Export and Training Data Delivery
...
Title
- FR FR7.1.1 Wireframes — Stage 7 — Export and Training Data Delivery
...
Mandates
- Locate FR FR7.1.2 in pmc/product/_mapping/fr-maps/prompts/04-FR-wireframes-prompt-E07.md at line 107.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-bmo-FR-wireframes-output-E07.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR7.1.2 Wireframes — Stage 7 — Export and Training Data Delivery
