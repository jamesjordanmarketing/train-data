...
Parameters
- FR Number: FR2.1.1
- Stage Name: Stage 2 — Content Ingestion & Processing Pipeline
...
# FR2.1.3 — Wireframe Generator Prompt (v4)
...
Mandates
- Locate FR FR2.1.3 in pmc/product/_mapping/fr-maps/prompts/04-FR-wireframes-prompt-E02.md at line 234.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-bmo-FR-wireframes-output-E02.md.
- Use the following markers when writing the final output block:
...
0) Extract journey context for Stage 2:
   ...
   - Progressive disclosure requirements
   - Persona-specific UI adaptations
1) Identify FR FR2.1.3 in the Task-Specific FR Map (or the main FR file if not present) and collect all acceptance criteria:
   - User Story Acceptance Criteria mapped to this FR
   - Functional Requirements Acceptance Criteria for this FR
2) Classify each criterion as UI-relevant vs Non-UI.
3) Compute a Page Plan (≥ 3) to satisfy all UI-relevant criteria with clear flows and states.
