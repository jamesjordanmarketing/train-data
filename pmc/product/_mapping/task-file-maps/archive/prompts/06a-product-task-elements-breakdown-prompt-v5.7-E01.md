...
1. Focus on tasks within section: ## 1. Foundation and Infrastructure Layer
...
4. For this run we are ONLY processing section: ## 1. Foundation and Infrastructure Layer

### 2. Task Selection
When processing a section:
1. Process all tasks within the specified section (i.e., all tasks from ## 1. Foundation and Infrastructure Layer)
2. Focus on providing consistent, high-quality elements rather than quantity
3. Read the entire ## 1. Foundation and Infrastructure Layer section first
...
For section ## 1. Foundation and Infrastructure Layer, you MUST:
...
1. File Specification:
   ...
   - Output file `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\task-file-maps\6-bmo-tasks-E01.md`
   ...
   - All work must be output to the file `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\task-file-maps\6-bmo-tasks-E01.md`
...
2. Processing Requirements:
   ...
   - **SECOND**: Read through all tasks in the section ## 1. Foundation and Infrastructure Layer before starting any work
...
5. **Task Analysis and Organization:**
   - First, conduct a comprehensive review of all tasks in the ## 1. Foundation and Infrastructure Layer section
...
3. Validation Phase:
   ...
   - Follow the test plan for this task in file: `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\test-maps\06-bmo-task-test-mapping-E01.md`
```
...
For each task you [the AI Coding Agent] there will be a detailed test mapping file here: Follow the test plan for this task in file: `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\test-maps\06-bmo-task-test-mapping-E01.md`
