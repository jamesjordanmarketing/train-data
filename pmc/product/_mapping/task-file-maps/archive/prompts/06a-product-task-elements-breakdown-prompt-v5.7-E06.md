...
1. Focus on tasks within section: ## 6. Quality Assurance and Validation
...
4. For this run we are ONLY processing section: ## 6. Quality Assurance and Validation

### 2. Task Selection
When processing a section:
1. Process all tasks within the specified section (i.e., all tasks from ## 6. Quality Assurance and Validation)
2. Focus on providing consistent, high-quality elements rather than quantity
3. Read the entire ## 6. Quality Assurance and Validation section first
...
For section ## 6. Quality Assurance and Validation, you MUST:
...
1. File Specification:
   ...
   - Output file `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\task-file-maps\6-bmo-tasks-E06.md`
   ...
   - All work must be output to the file `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\task-file-maps\6-bmo-tasks-E06.md`
...
2. Processing Requirements:
   ...
   - **SECOND**: Read through all tasks in the section ## 6. Quality Assurance and Validation before starting any work
...
5. **Task Analysis and Organization:**
   - First, conduct a comprehensive review of all tasks in the ## 6. Quality Assurance and Validation section
...
3. Validation Phase:
   ...
   - Follow the test plan for this task in file: `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\test-maps\06-bmo-task-test-mapping-E06.md`
```
...
For each task you [the AI Coding Agent] there will be a detailed test mapping file here: Follow the test plan for this task in file: `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\test-maps\06-bmo-task-test-mapping-E06.md`
