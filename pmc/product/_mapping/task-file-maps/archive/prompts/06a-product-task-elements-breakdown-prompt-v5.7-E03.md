...
1. Focus on tasks within section: ## 3. Training Data Generation Engine
...
4. For this run we are ONLY processing section: ## 3. Training Data Generation Engine

### 2. Task Selection
When processing a section:
1. Process all tasks within the specified section (i.e., all tasks from ## 3. Training Data Generation Engine)
2. Focus on providing consistent, high-quality elements rather than quantity
3. Read the entire ## 3. Training Data Generation Engine section first
...
For section ## 3. Training Data Generation Engine, you MUST:
...
1. File Specification:
   ...
   - Output file `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\task-file-maps\6-bmo-tasks-E03.md`
   ...
   - All work must be output to the file `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\task-file-maps\6-bmo-tasks-E03.md`
...
2. Processing Requirements:
   ...
   - **SECOND**: Read through all tasks in the section ## 3. Training Data Generation Engine before starting any work
...
5. **Task Analysis and Organization:**
   - First, conduct a comprehensive review of all tasks in the ## 3. Training Data Generation Engine section
...
3. Validation Phase:
   ...
   - Follow the test plan for this task in file: `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\test-maps\06-bmo-task-test-mapping-E03.md`
```
...
For each task you [the AI Coding Agent] there will be a detailed test mapping file here: Follow the test plan for this task in file: `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\test-maps\06-bmo-task-test-mapping-E03.md`
