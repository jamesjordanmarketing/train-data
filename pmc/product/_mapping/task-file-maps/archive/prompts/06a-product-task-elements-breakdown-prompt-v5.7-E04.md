...
1. Focus on tasks within section: ## 4. Advanced Content Adaptation
...
4. For this run we are ONLY processing section: ## 4. Advanced Content Adaptation

### 2. Task Selection
When processing a section:
1. Process all tasks within the specified section (i.e., all tasks from ## 4. Advanced Content Adaptation)
2. Focus on providing consistent, high-quality elements rather than quantity
3. Read the entire ## 4. Advanced Content Adaptation section first
...
For section ## 4. Advanced Content Adaptation, you MUST:
...
1. File Specification:
   ...
   - Output file `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\task-file-maps\6-bmo-tasks-E04.md`
   ...
   - All work must be output to the file `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\task-file-maps\6-bmo-tasks-E04.md`
...
2. Processing Requirements:
   ...
   - **SECOND**: Read through all tasks in the section ## 4. Advanced Content Adaptation before starting any work
...
5. **Task Analysis and Organization:**
   - First, conduct a comprehensive review of all tasks in the ## 4. Advanced Content Adaptation section
...
3. Validation Phase:
   ...
   - Follow the test plan for this task in file: `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\test-maps\06-bmo-task-test-mapping-E04.md`
```
...
For each task you [the AI Coding Agent] there will be a detailed test mapping file here: Follow the test plan for this task in file: `C:\Users\james\Master\BrightHub\BRun\brun4a\pmc\product\_mapping\test-maps\06-bmo-task-test-mapping-E04.md`
